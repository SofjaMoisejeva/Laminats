...
# ievade
istabas_garums = float(input("Ievadiet istabas garumu (m2) "))
istabas_platums = float(input("Ievadiet istabas platumu (m2) "))
pakas_cena = float(input("Ievadiet pakas cenu (EUR) "))
pakas_platība = float(input("Ievadiet pakas sedzošu platibu (m2) "))
